...
class LatestMunicipioDemografia
{
    ...
    {
        return DB::table('demografia_municipio as md_year_source')
    ...
    public static function join(Builder $query, string $municipioColumn, string $yearAlias = 'md_year', string $demografiaAlias = 'md_latest'): Builder
    {
        ...
        return $query->leftJoin("demografia_municipio as {$demografiaAlias}", function ($join) use ($yearAlias, $demografiaAlias): void {
